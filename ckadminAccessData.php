    ...
    <html lang="en">
        ...
        <body class="p-3 bg-dark text-white">
            <div class="container">
                ...
                <?php if($count>0){?>
                    ...
                    <!--<form action="cksearchData.php" class="mt-5" method="POST"> deleteTextField.php
                        <label for="">Search Car</label>
                        <input type="text" placeholder="Input Car Name" name="carname">
        ...
        <script>
            function checkAll(){
                ...
                console.log(formElement); // 7 = รวม input
